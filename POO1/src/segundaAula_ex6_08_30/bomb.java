...
public class bombaCombustivel {
    public static void main(String[] args) {
        bombaCombustivel bomba = new bombaCombustivel(bomba.TipoComb.COMUM, 500);
        ...
        while (!sair) {
            ...
            switch (opcao) {
                ...
                case 4:
                    ...
                    switch (tipoComb) {
                        case 1:
                        bomba.alterarComb(bomba.TipoComb.COMUM);
                            break;
                        case 2:
                        bomba.alterarComb(bomba.TipoComb.ADITIVADA);
                            break;
                        case 3:
                            bomba.alterarComb(bomba.TipoComb.PODIUM);
                            break;
                        default:
